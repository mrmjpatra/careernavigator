  ...
  first-letter:mr-3 first-letter:pl-3 first-letter:float-left text-justify'>
            ...
            <div className='my-4 py-4 pl-4'>
                ...
                <Link href={'/schools?data=cbse'}
                    className='inline-block w-1/2 my-4 px-6 py-4 bg-red-600 text-2xl font-bold text-center text-white hover:bg-red-800 rounded-md hover:shadow-md hover:shadow-red-400 transition-all duration-200 ease-in'
                >Find Now</Link>
            </div>
            <div className='px-6'>
                <ServiceCard />
