            ...
            <div className='md:w-3/4 w-11/12 mx-auto flex md:flex-row flex-col gap-4 pb-5 md:h-[350px]'>
                ...
                <div className='md:w-3/5'>
                    <div className='flex justify-between pb-5'>
                        ...
                        <Link href={'/schools'} className='text-blue-600 px-3 mt-2 py-1 border rounded border-blue-600 hover:bg-blue-600 hover:text-white transition-all ease-out duration-200'>EXPLORE</Link>
                    </div>
                    <ul className='flex flex-wrap'>
                        {
                            ...
                            <Link href={list.href} className='flex items-center gap-4 justify-between' >
                                {list.title}
